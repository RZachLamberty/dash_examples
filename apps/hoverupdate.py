...
def update_graph_v2(xaxis_column_name, yaxis_column_name, xaxis_type,
    ...
    return {
        'data': [go.Scatter(
            ...
            text=dff[
                dff['Indicator Name'] == yaxis_column_name
            ]['Country Name'],
            customdata=dff[
                dff['Indicator Name'] == yaxis_column_name
            ]['Country Name'],
...
def update_y_timeseries(hoverData, xaxis_column_name, axis_type):
    ...
    dff = dfind[dfind['Country Name'] == country_name]
...
def update_x_timeseries(hoverData, yaxis_column_name, axis_type):
    dff = dfind[dfind['Country Name'] == hoverData['points'][0]['customdata']]
